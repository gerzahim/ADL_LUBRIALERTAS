...
$archivo= $client->call("GetFile",array('auditoria'),"http://METLTQ87/webservice");
...
switch(ACCION) {
	...
	default:
		...
		// Funcion para llamar todos los campos de la tabla TR001_Historial
		$auditoria = $client->call("GetAuditoria",array($obj_config->GetVar('num_registros'),$pag),"http://METLTQ87/webservice")
