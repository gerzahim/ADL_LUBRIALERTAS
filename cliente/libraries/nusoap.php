...
// necessary classes
require_once('class.soapcliente.php');
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (soap_cliente->response has contents of the response)");
			return false;
		}
...
* @access   public
*/
class soap_cliente extends nusoap_base  {
	...
	* @access   public
	*/
	function soap_cliente($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends soap_cliente {
	'.$evalStr.'
}';
		return $evalStr;
	}
