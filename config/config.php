...
class ConfigVars{
	 ...
	 */
	private $vTituloSistema= "An&aacute;lisis de Lubricantes";
		/**
	 * Titulo del banner.
	 *
	 * @var string $vTituloBanner
	 */
	private $vTituloBanner= "Lubrialertas";
	...
	public function __construct() {
		...
		$this->vConfigVar= array(
			...
			'titulo_banner'=>$this->vTituloBanner,
